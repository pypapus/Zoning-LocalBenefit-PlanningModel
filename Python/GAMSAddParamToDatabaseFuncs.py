...
##### ADD FRAC OF DEMAND SERVED BY RENEWABLES (MINIMUM BOUND ON GENERATION)
def addSolarMinGen(db, currSolarGenFracOfDemand):
    add0dParam(db,'pSolarGenAsFracOfDemand',currSolarGenFracOfDemand/100)

def addWindMinGen(db, currWindGenFracOfDemand):
    add0dParam(db,'pWindGenAsFracOfDemand',currWindGenFracOfDemand/100)
