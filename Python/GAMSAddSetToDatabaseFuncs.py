...
def addGeneratorSets(db,genFleet):
    ...
    addSet(db,genFleet['GAMS Symbol'].loc[genFleet['PlantType'] == 'Nuclear'].tolist(),'nuclearegu')
    addSet(db,genFleet['GAMS Symbol'].loc[genFleet['PlantType'] == 'Combined Cycle'].tolist(),'CCSegu')
    # add state solar sets
    addSet(db,genFleet['GAMS Symbol'].loc[(genFleet['FuelType']=='Solar') & (genFleet['STATE']=='MI')].tolist(),'MISolaregu')
    addSet(db,genFleet['GAMS Symbol'].loc[(genFleet['FuelType']=='Solar') & (genFleet['STATE']=='IL')].tolist(),'ILSolaregu')
    addSet(db,genFleet['GAMS Symbol'].loc[(genFleet['FuelType']=='Solar') & (genFleet['STATE']=='MN')].tolist(),'MNSolaregu')
    addSet(db,genFleet['GAMS Symbol'].loc[(genFleet['FuelType']=='Solar') & (genFleet['STATE']=='IN')].tolist(),'INSolaregu')
    addSet(db,genFleet['GAMS Symbol'].loc[(genFleet['FuelType']=='Solar') & (genFleet['STATE']=='OH')].tolist(),'OHSolaregu')
    addSet(db,genFleet['GAMS Symbol'].loc[(genFleet['FuelType']=='Solar') & (genFleet['STATE']=='WI')].tolist(),'WISolaregu')
    return genSet
...
def addNewTechsSets(db,newTechsCE):
    ...
    windSet = addSet(db,newTechsCE['GAMS Symbol'].loc[newTechsCE['FuelType']=='Wind'].tolist(),'windtech')
    solarSet = addSet(db,newTechsCE['GAMS Symbol'].loc[newTechsCE['FuelType']=='Solar'].tolist(),'solartech')
    #State Renewable Energy
    addSet(db,newTechsCE['GAMS Symbol'].loc[(newTechsCE['FuelType']=='Solar') & (newTechsCE['STATE']=='MI')].tolist(),'MISolartech')
    addSet(db,newTechsCE['GAMS Symbol'].loc[(newTechsCE['FuelType']=='Solar') & (newTechsCE['STATE']=='IL')].tolist(),'ILSolartech')
    addSet(db,newTechsCE['GAMS Symbol'].loc[(newTechsCE['FuelType']=='Solar') & (newTechsCE['STATE']=='MN')].tolist(),'MNSolartech')
    addSet(db,newTechsCE['GAMS Symbol'].loc[(newTechsCE['FuelType']=='Solar') & (newTechsCE['STATE']=='IN')].tolist(),'INSolartech')
    addSet(db,newTechsCE['GAMS Symbol'].loc[(newTechsCE['FuelType']=='Solar') & (newTechsCE['STATE']=='OH')].tolist(),'OHSolartech')
    addSet(db,newTechsCE['GAMS Symbol'].loc[(newTechsCE['FuelType']=='Solar') & (newTechsCE['STATE']=='WI')].tolist(),'WISolartech')
    #Storage
    ...
    return techSet,reSet,windSet,solarSet,stoSet,stoSymbols,thermalSet,dacsSet,CCSSet
