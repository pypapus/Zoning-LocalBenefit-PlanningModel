...
*****************CALCULATE LOCAL BENEFITS (PROPERTY TAXES)*******************
economicbenefits..       vFixedbenefitsannual =e= sum(solartech, vN(solartech)* (pCapactech(solartech)* pPropTax(solartech)*pCrf(solartech)));
