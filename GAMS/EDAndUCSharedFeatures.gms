...
*Existing generators
         egu                             existing generators
                 ...
                 nuclearegu(egu)              egus that are nuclear
                 CCSegu(egu)                  egus that are nuclear
                 
*Existing solar generators at the state level
                 MISolaregu(renewegu)
                 ILSolaregu(renewegu)
                 MNSolaregu(renewegu)
                 INSolaregu(renewegu)
...
*ZONAL AND STATE PROPERTIES
                pDemandMI(z,h)                         hourly electricity demand [GWh] for MI
                pDemandIL(z,h) 
                pDemandMN(z,h) 
                pDemandIN(z,h) 
                pDemandOH(z,h) 
...
$gdxin %gdxincname%
$load egu, renewegu, windegu, solaregu, hydroegu, h, z, l, dacsegu, storageegu, nuclearegu, CCSegu
$load MISolaregu, ILSolaregu, MNSolaregu, INSolaregu, OHSolaregu, WISolaregu
...
$load pDemandMI, pDemandIL, pDemandMN, pDemandIN, pDemandOH, pDemandWI 
