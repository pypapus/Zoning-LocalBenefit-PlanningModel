...
*$include CESharedFeaturesValueAdded.gms
$include CESharedFeaturesSBM.gms
...
************************************************************************
******************CALCULATE COSTS (OBJ FUNC)**********changes
*Objective: minimize fixed + variable costs
objfunc..                vZannual =e= pCostWeight * (vFixedcostannual + vVarcostannual) - pBenefitWeight*vFixedbenefitsannual;
**************************************************
